...
//		Iterator<IRequestMapper> i = application.getRootRequestMapperAsCompound().iterator();
//
//		List<IRequestMapper> maps = new ArrayList<IRequestMapper>();
//
//		while (i.hasNext()) {
//			IRequestMapper mapper = i.next();
//			maps.add(mapper);
//		}
//		
...
//		for (IRequestMapper m : maps) {
//			this.systemMapper.add(m);
//		}
	}
